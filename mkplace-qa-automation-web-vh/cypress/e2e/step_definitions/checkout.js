...
Given("que o usuário adiciona um ou mais itens ao carrinho", () => {
    cy.loginViaAPI()
    cy.visit('/')
    checkoutPage.addProductToCard('Bolsa Tank Bucket Capitone Medium')
})
...
Then("a compra deve ser concluída com sucesso apresentando a seguinte mensagem {string}", (message) => {
    cy.xpath('//*[@id="__next"]/div/div/div/div[1]/div[3]/div/div[4]/div[2]/section/p').contains(message).should('be.ok')
})
