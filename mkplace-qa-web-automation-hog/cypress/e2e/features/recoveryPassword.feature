Feature: Recovery Password
    ...
    #     When clicar no link esqueci minha senha, informar o e-mail "helder.fernandes@mkplace.com.br" e clicar em recuperar senha
    ...
    #     Then deve retornar a mensagem "User not found" informando que o usuário informando não foi encontrado
